...
export default function ViatorPage() {
  ...
  useEffect(() => {
    ...
    fetch(`/api/bots/viator/equity?start=${start}&end=${today}`)
      .then((r) => r.json())
      .then(setData);
  }, []);
            ...
            <div className="box-hover relative overflow-hidden rounded-3xl px-6 py-12 lg:px-8 lg:py-16 h-full flex flex-col justify-between">
              ...
              <div className="wow fadeInUp relative z-10 text-left flex flex-col">
                ...
                <p className="mb-10 font-medium text-white text-lg">
                  Viator is a wanderer through market sectors, never staying in one place too long. 
                  This bot travels from opportunity to opportunity, exploring different industries and 
                  styles. It seeks momentum wherever it appears—technology, consumer goods, financials—
                  always moving to where the action is strongest.
                </p>
                ...
                <div className="mt-auto flex justify-center">
                  <video
                    ...
                    preload="metadata"
                  >
                    <source src="/images/Monsters/Viator2025.mp4" type="video/mp4" />
            ...
            >
              <div className="wow fadeInUp relative z-10 flex justify-center">
                <div className="relative aspect-square w-full max-w-[380px]">
                  ...
                  >
                    <Image
                      src="/images/Monsters/ViatorMonstra.png"
                      alt="Viator Traveler"
                      width={380}
                      height={380}
                      priority
              ...
              <div className="relative z-10 mt-10 text-left">
                <p className="text-white/80 text-sm leading-relaxed">
                  With a compass that points toward opportunity, Viator roams freely across market 
                  landscapes. He's not tied to any single sector or strategy—he follows the strongest 
                  signals wherever they lead. Today's destination is tomorrow's starting point.
                </p>

                <div className="mt-4 text-xs text-white/60">
                  Trait: <span className="text-white/80">Opportunistic exploration</span>
                </div>
              </div>
            </div>
          </div>
