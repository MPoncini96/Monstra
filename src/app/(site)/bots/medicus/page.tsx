...
export default function MedicusPage() {
  ...
  useEffect(() => {
    ...
    fetch(`/api/bots/medicus/equity?start=${start}&end=${today}`)
      .then((r) => r.json())
      .then(setData);
  }, []);
            ...
            <div className="box-hover relative overflow-hidden rounded-3xl px-6 py-12 lg:px-8 lg:py-16 h-full flex flex-col justify-between">
              ...
              <div className="wow fadeInUp relative z-10 text-left flex flex-col">
                ...
                <p className="mb-10 font-medium text-white text-lg">
                  Medicus specializes in healthcare and pharmaceutical sectors, diagnosing market 
                  conditions and prescribing strategic positions. This bot monitors biotech innovations, 
                  healthcare trends, and demographic shifts. When the sector shows vitality, Medicus 
                  invests heavily. When treatment fails, it withdraws to preserve capital.
                </p>
                ...
                <div className="mt-auto flex justify-center">
                  <video
                    ...
                    preload="metadata"
                  >
                    <source src="/images/Monsters/Medicus2025.mp4" type="video/mp4" />
            ...
            >
              ...
              <div className="relative z-10 mt-10 text-left">
                <p className="text-white/80 text-sm leading-relaxed">
                  ...
                  and growth. He doesn't gamble—he diagnoses. Reading the vital signs of healthcare 
                  markets, he applies his expertise where it matters most, always ready to adapt when 
                  conditions change.
                </p>

                <div className="mt-4 text-xs text-white/60">
                  Trait: <span className="text-white/80">Analytical precision</span>
                </div>
              </div>
            </div>
          </div>
