    ...
    const fetchData = async () => {
      try {
        ...
        const response = await fetch(
          `/api/bots/imperium/equity?start=${startDate}&end=${today}`,
          { cache: "no-store" }
        );
  ...
  return (
            ...
            <div className="box-hover relative overflow-hidden rounded-3xl px-6 py-12 lg:px-8 lg:py-16 h-full flex flex-col justify-between">
              ...
              <div className="wow fadeInUp relative z-10 text-left flex flex-col">
                ...
                <h1 className="mb-4.5 text-heading-2 font-bold text-white">
                  Imperium: The Empire Builder
                </h1>

                <p className="mb-10 font-medium text-white text-lg">
                  Imperium commands with authority and strategic vision. This bot focuses on building 
                  dominant positions in market-leading companies, holding them with conviction through 
                  volatility. Like an empire, it's built on strong foundations and long-term thinking, 
                  only retreating when the fundamental structure shows signs of weakness.
                </p>
                ...
                <div className="mt-auto flex justify-center">
                  <video
                    ...
                    preload="metadata"
                  >
                    <source src="/images/Monsters/Imperium2025.mp4" type="video/mp4" />
            ...
            >
              ...
              <div className="relative z-10 mt-10 text-left">
                <p className="text-white/80 text-sm leading-relaxed">
                  Crowned in the halls of power, Imperium rules with calculated patience. He doesn't 
                  chase fleeting gains but builds positions that stand the test of time. When the 
                  foundation remains strong, Imperium holds. When cracks appear, he rebuilds elsewhere.
                </p>

                <div className="mt-4 text-xs text-white/60">
                  Trait: <span className="text-white/80">Strategic dominance</span>
                </div>
              </div>
            </div>
          </div>
    ...
    <section suppressHydrationWarning className="pb-4">
      <div className="mx-auto flex max-w-[1170px] justify-center px-4 sm:px-8 xl:px-0">
        <SubscribeButton botId="imperium" />
      </div>
    </section>
