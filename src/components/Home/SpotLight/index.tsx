            ...
            <div className="box-hover relative overflow-hidden rounded-3xl px-6 py-12 lg:px-8 lg:py-16 h-full flex flex-col justify-between">
                  ...
                  <div className="wow fadeInUp relative z-10 text-left flex flex-col">
                    ...
                    <p className="mb-10 font-medium text-white text-lg">
                      Vis, named after strength and force, channels market power into the energy
                      sector. It tracks energy leaders, concentrates on the strongest performers,
                      and steps aside when momentum fades—flowing back into the broader market.
                      When risk rises, Vis pulls back defensively, then re-enters when conditions
                      recover. It’s a strategy built to apply force with discipline: striking when
                      energy is strong and standing down when it’s not.
                    </p>
            ...
            >
                  ...
                  <div className="relative z-10 mt-10 text-left">
                    <p className="text-white/80 text-sm leading-relaxed">
                      Born in the glow of refinery fires and the hum of offshore rigs, Vis doesn’t
                      chase noise—he hunts pressure. He watches the sector’s pulse, waits for the
                      strongest current, then moves with purpose. When the air turns thin and risk
                      creeps in, Vis vanishes into the dark… until the engines roar again.
                    </p>
