          ...
          <div className="w-full max-w-[534px]">
            <form suppressHydrationWarning>
              <div className="flex items-center gap-4">
                ...
                <button
                  suppressHydrationWarning
                  className="button-border-gradient hover:button-gradient-hover relative flex items-center gap-1.5 rounded-lg px-7 py-3.5 text-sm text-white shadow-button hover:shadow-none"
                >
                  Subscribe
                </button>
              </div>
