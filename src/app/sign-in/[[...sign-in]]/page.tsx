...
const appearance = {
  variables: {
    ...
    colorWarning: "#8646f4", // purple for warnings (replacing orange)
    colorSuccess: "#8646f4", // purple for success (replacing green/orange)
  ...
  elements: {
    ...
    formButtonPrimary: "bg-purple hover:bg-purple-dark text-white font-semibold py-2 rounded-lg transition",
